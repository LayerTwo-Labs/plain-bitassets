...
use sidechain_utilities::types::OutPoint;
...
async fn unknown_withdrawal_task(
    ...
    .await?;
    tracing::info!("Setup BitAssets withdrawer node successfully");
    ...
    .await?;
    tracing::info!("Setup BitAssets successor node successfully");
